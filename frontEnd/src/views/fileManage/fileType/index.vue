<template>
    <div class="app-container">
      <!-- <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="78px">
        <el-form-item label="类型名" prop="dataTypeName">
          <el-input
            ...
            placeholder="请输入数据类型名"
            clearable
            @keyup.enter.native="handleQuery"
          />
        </el-form-item>
        <el-form-item label="类型描述" prop="dataTypeDesc">
          <el-input
      ...
      <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          ...
          <el-form-item label="数据类型名" prop="dataTypeName">
            <el-input v-model="form.dataTypeName" placeholder="请输入数据类型名" />
          </el-form-item>
  ...
  <script>
  import { listType, getType, delType, addType, updateType } from "@/api/fileManage/fileType";
